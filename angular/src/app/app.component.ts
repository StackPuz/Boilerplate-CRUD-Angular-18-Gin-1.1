            ...
            <nav class="navbar bg-light border-bottom">
              <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                  ...
                  <li class="dropdown">
                    <a class="nav-link text-secondary dropdown-toggle" data-bs-toggle="dropdown" href="#"><i class="fa fa-user"></i> <span class="d-none d-lg-inline"> {{user.getUser().name}}</span></a>
