          ...
          <div class="col-12"><input id="searchbar_toggle" type="checkbox" />
            <div id="searchbar" class="mb-4">
              <div class="form-group col-lg-2 me-2 mb-lg-0 mb-3">
                <select id="search_col" (change)="util.searchChange()" class="form-select form-select-sm">
            ...
            <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                <tr *ngFor="let product of products">
                  ...
                  <td class="d-none d-md-table-cell text-center"><a *ngIf="product.Image" href="http://localhost:8080/uploads/products/{{product.Image}}" target="_blank" title="{{product.Image}}"><img class="img-list" src="http://localhost:8080/uploads/products/{{product.Image}}" /></a></td>
                  <td>{{product.Name}}</td>
